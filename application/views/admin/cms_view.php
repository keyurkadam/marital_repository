                 ...
                 <table class="table table-striped table-bordered bootstrap-datatable">
                          ...
                          foreach($resultset->result() as $row)
                          {
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable">
                                ...
                                <tr>
                                    <td><?php echo $row->cms_copyright; ?></td>
                                </tr>
                            </table>
                            <table class="table table-striped table-bordered bootstrap-datatable">
                                <tr>
                                ...
                                <tr>
                                    <td><?php echo $row->cms_trade_mark; ?></td>
                                </tr>
                            </table>
                            <table class="table table-striped table-bordered bootstrap-datatable">
                                <tr>
                                ...
                                <tr>
                                    <td><?php echo $row->cms_terms_condition; ?></td>
                                </tr>
                            </table>
                            <table class="table table-striped table-bordered bootstrap-datatable">
                                <tr>
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable">
                                ...
                                <tr>
                                    <td><?php echo $row->cms_faq; ?></td>
                                </tr>
                            </table>
                            
                            <table class="table table-striped table-bordered bootstrap-datatable">
                                <tr>
                                    <th><h2>Wedding Resources</h2></th>
                                </tr>
                                <tr>
                                    <td><?php echo $row->cms_wedding_resources; ?></td>
                                </tr>
                            </table>

                            <table class="table table-striped table-bordered bootstrap-datatable">
                                <tr>
                                    <th><h2>Disclaimer</h2></th>
                                </tr>
                                <tr>
                                    <td><?php echo $row->cms_disclaimer; ?></td>
                                </tr>
                            </table>
